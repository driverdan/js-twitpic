(function() {
  var API, OAuth, TwitPic, http, querystring;
  ...
  */
  TwitPic = (function() {
    ...
    TwitPic.prototype.upload = function(file, message) {};
    TwitPic.prototype.uploadAndPost = function(file, message) {};
    return TwitPic;
  })();
  /*
  ...
  API = {
    ...
    */
    postQuery: function(url, creds, data, callback) {
      var client, headers, oa, postBody, req;
    ...
    buildHeader: function(oa, creds) {
      var header, name, params, sig, value;
      params = {
